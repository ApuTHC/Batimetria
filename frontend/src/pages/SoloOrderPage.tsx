        ...
        <div className="overflow-x-auto container mx-auto px-4 pt-11">
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tr className="border-b dark:border-gray-700">
                    ...
                    <td className="px-4 py-3">
                        {data && data.created_at !== undefined && data.created_at !== null && (
                    ...
                    <td className="px-4 py-3">
                        <div className="flex justify-center gap-4">
                            {data && data.shipping_address.city !== undefined && data.shipping_address.city !== null && (
                                <>
                    ...
                    <td className="px-4 py-3">
                        <div className="flex justify-center gap-4">
                            ...
                            {data && data.shipping_address.address !== undefined && data.shipping_address.address !== null  && (
                                <>
                    ...
                    <td className="px-4 py-3">
                        <div className="flex justify-center gap-4">
                            ...
                            {data && data.shipping_address.postal_code !== undefined && data.shipping_address.postal_code !== null  && (
                                <>
